...
(function() {
    ...
    async function isMediumPost(url) {
        ...
        return text.includes('class="meteredContent"');
    }
    ...
    (async function() {
        ...
        if (!isReadcacheLink(currentUrl)) {
            ...
            if (body.includes("Error fetching data from Google Web Cache")) {
                location.href = location.href.replace("https://readcache.xyz/api/p?url=", "https://freedium.cfd/");
            }
            if (body.includes("Bummer! 😜 We've tripped over a problem cord!")) {
                location.href = location.href.replace("https://freedium.cfd/medium.com/", "https://scribe.rip/");
            }
            if (body.includes("Error parsing the URL")) {
                location.href = location.href.replace("https://scribe.rip/", "https://libmedium.batsense.net/");
            }
    })();
})();
